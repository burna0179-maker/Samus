    ...
    _stub_call_states(
        ...
        [
            ...
            },
            {
                ...
                "state": "completed",
                "last_outcome": "follow_up",
                "updated_at": f"{today}T11:00:00Z",
            },
            {
                "prospect_id": "p4",
                "state": "no_answer",
                "last_outcome": "no_answer",
                "updated_at": f"{today}T12:00:00Z",
            },
            {
                "prospect_id": "p5",
                "state": "completed",
                "last_outcome": "noted",
                "updated_at": f"{today}T13:00:00Z",
            },
        ],
    )
...
def test_daily_stats_range_uses_between(monkeypatch):
        ...
        [
            {
                ...
                "state": "completed",
                "last_outcome": "booked",
                "updated_at": "2026-07-03T23:30:00Z",
            },
        ],
    )
    from backend.crm.service import daily_stats
    ...
    out = daily_stats(
        "2026-07-03",
        start="2026-07-03T07:00:00Z",
        end="2026-07-04T07:00:00Z",
    )
