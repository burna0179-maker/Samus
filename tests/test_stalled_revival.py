...
def test_full_sweep_caps_at_max_per_sweep(monkeypatch):
    ...
    monkeypatch.setattr(sr, "_stalled_opps",
                        lambda scan_limit, min_age_hours: fake_rows)
    ...
    monkeypatch.setitem(sys.modules, "backend.heat",
                        types.ModuleType("backend.heat"))
