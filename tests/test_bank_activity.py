                ...
                json.dumps(
                    {
                        "ts": now_iso,
                        "category": "bill",
                        "vendor": "vapi-voice-calls",
                        "amount_usd": 50.00,
                        "bill_signal_kind": "receipt",
                        "from_addr_tail": "mail.vapi.ai",
                        "subject_head": "Receipt",
                    }
                )
                + "\n"
            )
            ...
            json.dumps(
                {
                    ...
                    "external_id": "abc123",
                    "amount_usd": -10.00,
                    "raw_description": "VAPI API",
                    "vendor_registry_id": "vapi-voice-calls",
                    "category": "bill",
                    "bill_signal_kind": "receipt",
                    "card_ref": "Business debit 4801",
                    "bank_category": "Software and subscriptions",
                    "note": "",
                }
            )
            + "\n"
        ...
        for row in [
            {
                ...
                "external_id": "r1",
                "amount_usd": 220.00,
                "raw_description": "alex hartman",
                "vendor_registry_id": "",
                "category": "revenue",
                "bill_signal_kind": "",
                "card_ref": "",
                "bank_category": "Business income",
                "note": "",
            },
            {
                "ts": now_iso,
                ...
                "external_id": "t1",
                "amount_usd": 33.20,
                "raw_description": "Team payments to Primary",
                "vendor_registry_id": "",
                "category": "transfer",
                "bill_signal_kind": "",
                "card_ref": "",
                "bank_category": "Personal",
                "note": "",
            },
        ]:
...
def test_personal_csv_parses_and_classifies_business_signals(tmp_path):
    ...
    with csv_p.open("w", encoding="utf-8") as fh:
        ...
        fh.write(
            '"2026-06-01 08:00:00 PDT","","P2P","USD","$50.00","","$50.00","","","","COMPLETE","website maintenance","Sample Customer","Cash Balance"\n'
        )
        # Personal spending
        fh.write(
            '"2026-06-05 10:00:00 PDT","","Cash Card","USD","-$12.77","","-$12.77","","","","COMPLETE","SUBWAY 46308","","Cash Balance"\n'
        )
        # LLC funding
        fh.write(
            '"2025-12-13 08:00:00 PDT","","Cash Card","USD","-$1000.00","","-$1000.00","","","","COMPLETE","HUSTLEFORGE","","Cash Balance"\n'
        )
        # Borrow (personal, but tracked for founder cash-health)
        fh.write(
            '"2026-07-01 08:00:00 PDT","","Borrow","USD","-$5.25","","-$5.25","","","","COMPLETE","Borrowing in Cash App","","Cash Balance"\n'
        )
        # P2P sent to friend (personal)
        fh.write(
            '"2026-07-05 10:00:00 PDT","","P2P","USD","-$10.00","","-$10.00","","","","COMPLETE","fob","Sample Customer","Cash Balance"\n'
        )
            ...
            json.dumps(
                {
                    ...
                    "external_id": "b1",
                    "amount_usd": -5.25,
                    "raw_description": "Borrow",
                    "vendor_registry_id": "",
                    "category": "personal",
                    "bill_signal_kind": "",
                    "card_ref": "Cash Balance",
                    "bank_category": "Borrow",
                    "note": "",
                }
            )
            + "\n"
