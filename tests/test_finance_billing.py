...
def _stub_stripe(monkeypatch, *, links: list | None = None, raise_exc: Exception | None = None):
...
def test_summarize_extracts_offer_code():
    ...
    links = [
        StripePaymentLink(
            ...
            metadata={"hf_offer_code": "seo_audit", "samus_managed": "true"},
        ),
    ]
    ...
    out = summarize_links(
        [
            StripePaymentLink(
                ...
                url="https://x/a",
                livemode=True,
                metadata={"hf_offer_code": "named_one", "samus_managed": "true"},
            ),
            StripePaymentLink(
                id="plink_b", url="https://x/b", livemode=True, metadata={"samus_managed": "true"}
            ),
        ]
    )
