    ...
    _write_ledger(
        ...
        [
            ...
            },
            {
                ...
                "vendor": "aws-other",
                "amount_usd": 100.00,
                "bill_signal_kind": "invoice",
                "from_addr_tail": "aws.amazon.com",
                "subject_head": "Invoice",
            },
            {
                "ts": now_iso,
                "category": "social",
                "from_addr_tail": "linkedin.com",
                "subject_head": "Notification",
            },
        ],
    )
    monkeypatch.setenv("SAMUS_GMAIL_INBOX_LEDGER_PATH", str(ledger))
        ...
        [
            {
                "ts": now_iso,
                "category": "bill",
                "vendor": "openai-chatgpt-plus",
                "amount_usd": 20.00,
                "bill_signal_kind": "payment_declined",
                "from_addr_tail": "openai.com",
                "subject_head": "Declined",
            },
            {
                "ts": now_iso,
                "category": "bill",
                "vendor": "anthropic-claude-subscription",
                "amount_usd": 20.00,
                "bill_signal_kind": "receipt",
                "from_addr_tail": "anthropic.com",
                "subject_head": "Receipt",
            },
        ],
    )
        ...
        [
            {
                "ts": now_iso,
                "from_addr_tail": "mail.vapi.ai",
                "subject_head": "Your Vapi invoice for $75.00",
                "persisted": True,
            },
        ],
    )
