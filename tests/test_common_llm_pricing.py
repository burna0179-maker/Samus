...
def test_compute_cost_haiku_input_and_output():
    ...
    cost = compute_cost_usd(
        "claude-haiku-4-5", input_tokens=100_000, output_tokens=50_000,
    )
...
def test_compute_cost_opus_is_much_higher_than_haiku():
    ...
    haiku = compute_cost_usd(
        "claude-haiku-4-5", input_tokens=10_000, output_tokens=10_000,
    )
    opus = compute_cost_usd(
        "claude-opus-4", input_tokens=10_000, output_tokens=10_000,
    )
...
def test_compute_cost_negative_tokens_clamped_to_zero():
    ...
    cost = compute_cost_usd(
        "claude-haiku-4-5", input_tokens=-1000, output_tokens=-500,
    )
    assert cost == 0.0
...
def test_compute_cost_4_decimal_precision():
    ...
    cost = compute_cost_usd(
        "claude-haiku-4-5", input_tokens=1, output_tokens=0,
    )
    # Decimal quantize HALF_UP: 0.0000008 -> 0.0000
    assert cost == 0.0
    # 1250 input tokens = $0.001 exactly -> 0.0010
    cost = compute_cost_usd(
        "claude-haiku-4-5", input_tokens=1250, output_tokens=0,
    )
