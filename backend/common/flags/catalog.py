...
def build_specs() -> list[FlagSpec]:
    ...
    specs: list[FlagSpec] = [
        ...
        b(
            "cash_engine_live_send_enabled",
            "SAMUS_CASH_ENGINE_LIVE_SEND",
            "revenue",
        ...
        b(
            "prospecting_in_stack_cadence_enabled",
        ...
        b(
            "website_content_generation_enabled",
        ...
        b(
            "website_asset_isolation_strict",
            "SAMUS_WEBSITE_ASSET_ISOLATION_STRICT",
            "website",
        ...
        b(
            "website_seo_enrich_enabled",
            "SAMUS_WEBSITE_SEO_ENRICH_ENABLED",
            "website",
        ...
        b(
            ...
            "SAMUS_WEBSITE_MEDIA_GEN_ENABLED",
            "media",
        ...
        b(
            "social_reel_video_enabled",
            "SAMUS_SOCIAL_REEL_VIDEO_ENABLED",
            "social",
        ...
        b(
            ...
            "SAMUS_TIKTOK_CONTENT_POSTING_ENABLED",
            "commerce",
            "TikTok content posting. Dormant + dry-run by default; needs an operator-approved app.",
        ),
        b(
            "tiktok_shop_enabled",
            "SAMUS_TIKTOK_SHOP_ENABLED",
            "commerce",
            "TikTok Shop Seller API (selling). Dormant by default; needs an approved seller app.",
        ),
        b(
            "tiktok_dry_run",
            "SAMUS_TIKTOK_DRY_RUN",
            "commerce",
            "Belt-and-braces: never posts/sells live while True (default ON).",
        ),
        # --- workflow automation deliverable ---------------------------
        b(
            "workflow_n8n_deliverable_enabled",
            "SAMUS_WORKFLOW_N8N_DELIVERABLE_ENABLED",
            "workflow",
            "Compile the TaskPlan into deployable n8n workflow JSON + runbook. "
            "Pure/offline/$0; default ON.",
        ),
        b(
            "workflow_n8n_llm_enrich",
            "SAMUS_WORKFLOW_N8N_LLM_ENRICH",
            "workflow",
            "Budget-gated LLM parameter-enrichment pass over the workflow. Dormant by default.",
        ),
        b(
            "workflow_n8n_deploy_enabled",
            "SAMUS_WORKFLOW_N8N_DEPLOY_ENABLED",
            "workflow",
            "Live POST of the generated workflow to an n8n instance. Dormant by default.",
        ),
        b(
            "workflow_n8n_dry_run",
            "SAMUS_WORKFLOW_N8N_DRY_RUN",
            "workflow",
        ...
        b(
            "crm_hivemind_projection_enabled",
        ...
        b(
            "taste_audit_enabled",
            "SAMUS_TASTE_AUDIT_ENABLED",
            "taste",
            "Run the deterministic zero-LLM taste Pre-Flight audit over deliverables. Default OFF.",
        ),
        b(
            "taste_pdc_gate_enabled",
            "SAMUS_TASTE_PDC_GATE_ENABLED",
            "taste",
            "Fold the taste verdict into the PDC composite as a soft (REVIEW) "
            "signal. Never BLOCKs on taste alone. Default OFF.",
        ),
        b(
            "taste_audit_block_on_fail",
        ...
        b(
            "stripe_reject_test_mode_in_production",
        ...
        b(
            ...
            "SAMUS_INTAKE_RATE_LIMIT_ENABLED",
            "security",
